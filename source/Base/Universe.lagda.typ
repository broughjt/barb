...
universes. There is a zeroth level and a successor function, which takes one
level to the next in the hierarchy. You can also take the join of two universe
levels.
